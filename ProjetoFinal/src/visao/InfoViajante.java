...
public class InfoViajante extends JFrame {
	...
	private JTextField txtStatusReserva;
	...
	public InfoViajante(InfoViagem viagemSelecionada, ListViagens janela) {
		setTitle("Informação da viagem selecionada");
		...
		JLabel lblNewLabel_1 = new JLabel("Id reserva da viagem:");
		lblNewLabel_1.setFont(new Font("Calibri", Font.BOLD, 12));
		contentPane.add(lblNewLabel_1, "cell 2 2");
		
		txtIdReserva = new JTextField();
		txtIdReserva.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtIdReserva.setEditable(false);
		contentPane.add(txtIdReserva, "cell 3 2 9 1,growx");
		txtIdReserva.setColumns(10);
		txtIdReserva.setText(String.valueOf(viagemSelecionada.getIdReserva()));
		
		JLabel lblNewLabel = new JLabel("Status da reserva:");
		lblNewLabel.setFont(new Font("Calibri", Font.BOLD, 12));
		contentPane.add(lblNewLabel, "cell 12 2");
		
		txtStatusReserva = new JTextField();
		txtStatusReserva.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtStatusReserva.setEditable(false);
		contentPane.add(txtStatusReserva, "cell 13 2 13 1,growx");
		txtStatusReserva.setColumns(10);
		txtStatusReserva.setText(String.valueOf(viagemSelecionada.getStatus()));
		
		JLabel lblNewLabel_5 = new JLabel("");
		contentPane.add(lblNewLabel_5, "cell 26 2");
		
		JLabel lblNewLabel_2 = new JLabel("Nome do viajante:");
		lblNewLabel_2.setFont(new Font("Calibri", Font.BOLD, 12));
		contentPane.add(lblNewLabel_2, "cell 2 3,alignx left");
		
		txtNome = new JTextField();
		txtNome.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtNome.setEditable(false);
		contentPane.add(txtNome, "cell 3 3 23 1,growx");
		...
		contentPane.add(lblNewLabel_1_1, "cell 2 4");
		
		txtEmail = new JTextField();
		txtEmail.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtEmail.setEditable(false);
		txtEmail.setColumns(10);
		contentPane.add(txtEmail, "cell 3 4 23 1,growx");
		...
		contentPane.add(lblNewLabel_1_1_1, "cell 2 5");
		
		txtTelefone = new JTextField();
		txtTelefone.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtTelefone.setEditable(false);
		txtTelefone.setColumns(10);
		contentPane.add(txtTelefone, "cell 3 5 9 1,growx");
		...
		contentPane.add(lblDestinoDaViagem, "cell 12 5");
		
		txtDestino = new JTextField();
		txtDestino.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtDestino.setEditable(false);
		txtDestino.setColumns(10);
		contentPane.add(txtDestino, "cell 13 5 13 1,growx");
		...
		contentPane.add(lblNewLabel_1_1_1_1, "cell 2 6");
		...
		contentPane.add(txtDataTermino, "cell 13 6 13 1,growx");
		
		JLabel lblNewLabel_1_1_1_1_1 = new JLabel("Tipo de acomodação:");
		lblNewLabel_1_1_1_1_1.setFont(new Font("Calibri", Font.BOLD, 12));
		contentPane.add(lblNewLabel_1_1_1_1_1, "cell 2 7");
		
		txtAcomodacao = new JTextField();
		txtAcomodacao.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtAcomodacao.setEditable(false);
		txtAcomodacao.setColumns(10);
		txtAcomodacao.setText(String.valueOf(viagemSelecionada.getAcomodacao()));
		contentPane.add(txtAcomodacao, "cell 3 7 9 1,growx");
		
		JLabel lblMeioDeTransporte = new JLabel("Meio de transporte:");
		lblMeioDeTransporte.setFont(new Font("Calibri", Font.BOLD, 12));
		contentPane.add(lblMeioDeTransporte, "cell 12 7");
		
		txtTransporte = new JTextField();
		txtTransporte.setFont(new Font("Calibri", Font.ITALIC, 11));
		txtTransporte.setEditable(false);
		txtTransporte.setColumns(10);
		txtTransporte.setText(String.valueOf(viagemSelecionada.getTransporte()));
		contentPane.add(txtTransporte, "cell 13 7 13 1,growx");
		...
		contentPane.add(lblNewLabel_1_1_1_1_1_1, "cell 2 8");
		...
		contentPane.add(txtOrcamento, "cell 3 8 9 1,growx");
		...
		contentPane.add(lblDocumentoDoViajante, "cell 12 8");
		...
		contentPane.add(txtAtividade, "cell 3 9 23 1,growx");
		...
		contentPane.add(btnNewButton, "cell 0 10 29 1,alignx center,aligny center");
        ...
        txtStatusReserva.setBorder(roundedBorder);
        txtAcomodacao.setBorder(roundedBorder);
        txtTransporte.setBorder(roundedBorder);
	}
