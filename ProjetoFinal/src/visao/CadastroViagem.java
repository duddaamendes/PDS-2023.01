...
public class CadastroViagem extends JFrame {
	...
	public CadastroViagem(ListViagens list) {
		...
		contentPane.add(txtIdReserva, "cell 5 3 5 1,growx");
		...
		contentPane.add(cbStatus, "cell 11 3 11 1,growx");
		...
		contentPane.add(cbTransporte, "cell 11 8 11 1,growx");
		...
		btnCadastrarViagem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int posT = cbTransporte.getSelectedIndex();
				...
				v.setTransporte(traSel);

				v.setIdReserva(idReservaInt);
				v.setNome(nome);
				v.setEmial(email);
